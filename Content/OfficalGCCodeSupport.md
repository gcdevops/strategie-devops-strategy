...
* **[Pages](https://about.gitlab.com/product/pages/)** - To host documents and guides related to software development, and even static website including ones with GoC official theme.
...
Although a more fullsome cost evaluation should be performed when this proposal is adopted, it is believed that maintaining an internal instance will result in cost savings due to the need to have private repositories at the GC level.   
